...
<div class="cd-main-body cd-main-content box-shadow">
	...
	<br><br><br>
	<div align="center">
		<button><a href="{{route('admin.searchHistory')}}">Search Log</a></button>
		<button><a href="{{route('admin.adminList')}}">User List</a></button>
		<button><a href="{{route('registration.index')}}">Create Admin</a></button>
		<br>
		<button><a href="{{route('search.index')}}">Search Food</a></button>
		<button><a href="{{route('admin.stats')}}">Statistics</a></button>
		<br><br><br><br>
	</div>
	<br><br>
</div>
